...
public partial class MacroSutraCosmo(IConfiguration configuration, string connectionStringConfigurationName = "Cosmo:ConnectionString")
{
    ...
    private const string DatabaseName = "daisi-macrosutra";
    ...
    public async Task<Container> GetContainerAsync(string containerName)
    {
        ...
        {
            UsersContainerName => UsersPartitionKeyName,
            StrategiesContainerName => StrategiesPartitionKeyName,
            TradesContainerName => TradesPartitionKeyName,
            PortfoliosContainerName => PortfoliosPartitionKeyName,
